...
################################
#Code-
Sales_Stores <- data1[order(data1$Weekly_Sales,decreasing = T),]
Sales_Stores 
#Output-
...
#Code-
summarise(group_by(data1, Store), mean(Weekly_Sales))
tapply(data1$Weekly_Sales, data1$Store,mean)
aggregate(Weekly_Sales ~ Store, data1, sd)
aggregate(Weekly_Sales ~ Store, data1, var)
